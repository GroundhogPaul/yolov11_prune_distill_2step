...
class Pad:
    """
    Pads the image to the input width and height, filling the background with mean and putting the image in the top-
    left.
...
class PrepareMasks:
    ...
    This function doesn't do anything if cfg.use_gt_bboxes is False.
    """
...
class FastBaseTransform(torch.nn.Module):
    ...
    This doesn't support a lot of config settings and should only be used for production. Maintain this as necessary.
    """
