...
def bilinear_kernel(in_channels, out_channels, kernel_size):
    """Return a bilinear filter tensor 双线性卷积核，用于反卷积."""
...
class FCN32s(nn.Module):
    def __init__(self, num_classes):
        ...
        self.upsample32x = nn.Sequential(
            nn.ConvTranspose2d(
                num_classes, num_classes, kernel_size=3, stride=2, padding=1, dilation=1, output_padding=1
            ),
            nn.ConvTranspose2d(
                num_classes, num_classes, kernel_size=3, stride=2, padding=1, dilation=1, output_padding=1
            ),
...
class FCN16s(nn.Module):
    def __init__(self, num_classes):
        ...
        self.upsample2x = nn.ConvTranspose2d(
            num_classes, num_classes, kernel_size=3, stride=2, padding=1, output_padding=1, dilation=1
        )
